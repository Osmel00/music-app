...
export const ButtonGithub = ({ text }) => {
  ...
  return (
    <button onClick={googleCallServer}
      ...
      role="button"
      className=" transition ease-in-out duration-0 hover:duration-300 hover:scale-[1.1]  bg-slate-500 focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3 px-4 border rounded-3xl border-gray-700 flex items-center justify-center w-full mt-4"
    >
      <svg
        width={21}
        height={20}
